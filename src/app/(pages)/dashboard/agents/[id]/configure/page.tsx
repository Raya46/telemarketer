      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card style={{ backgroundColor: colors.card, borderColor: colors.border }}>
            <CardHeader>
              <CardTitle style={{ color: colors.primaryText }}>General Settings</CardTitle>
              <CardDescription style={{ color: colors.secondaryText }}>Pengaturan dasar untuk identitas agen Anda.</CardDescription>
            </CardHeader>
          ...
          <Card style={{ backgroundColor: colors.card, borderColor: colors.border }}>
            <CardHeader>
              <CardTitle style={{ color: colors.primaryText }}>Behavior & Personality</CardTitle>
              <CardDescription style={{ color: colors.secondaryText }}>Tentukan bagaimana agen Anda berinteraksi.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="grid gap-2">
        ...
        <div className="space-y-6">
            <Card style={{ backgroundColor: colors.card, borderColor: colors.border }}>
                <CardHeader>
                    <CardTitle style={{ color: colors.primaryText }}>Call Handling</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                        <Label style={{ color: colors.primaryText }}>Welcome Message</Label>
                        <Switch
                          checked={config.useWelcomeMessage}
                          onCheckedChange={(checked) => handleInputChange('useWelcomeMessage', checked)}
                          style={{ backgroundColor: config.useWelcomeMessage ? colors.accent : colors.border }}
                        />
                        </div>
                     ...
                     <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) => handleInputChange('callRecordings', checked)}
                          style={{ backgroundColor: config.callRecordings ? colors.accent : colors.border }}
                        />
                    </div>
                </CardContent>
            </Card>
             <Card style={{ backgroundColor: colors.card, borderColor: colors.border }}>
                <CardHeader>
                    <CardTitle style={{ color: colors.primaryText }}>Integration</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    <div className="grid gap-2">
